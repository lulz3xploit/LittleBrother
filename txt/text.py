text = ['Press F to hack', 'LEAVE ME HERE', 'The security is an illusion.', 'Profiler ctOS v2.0', 'DedSec takeover', 'Fsociety00.dat', 'Evil Corp',
 ...
 '101100100101100 01100110010110011001', '101100 0110011001', 'c2V5cHRvbyBteSBsb3Zl', '1 item in your web history: \'Fkk cuckold how to make your wife a hotwife zootube\'', '49 20 4c 4f 56 45 20 55', 'NB2HI4DTHIXS653XO4XHS33VOR2WEZJOMNXW2L3XMF2GG2B7OY6VUS3OKVZGQYSLJQ3GO===', 'Regarde derrière toi...',
 ...
 "HERP DERP HERP DERP","I LIKE TURTLES","(<3 <3)","(* *)","(X X)","(^ ^)","(@ @)","(! !)","(~ ~)", "Fre4ks_3xpl0it in my hearth", "recon-ng is useless...",
 "- Hey Rapido ! - Wé Razmo", "LV-426", "Origae-6", "Fiorina-16", "LittleBrother > recon-ng >= maltego", "F*ck Scr1p7 K1dd1es"]